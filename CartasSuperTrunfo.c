...
printf("estado:Goiás\n");
printf("carta:G02\n");
printf("cidade:Cavalcante\n");
printf("população:9.583\n");
printf("area km²:6.948,780\n");
printf("PIB:39.322,37\n");
printf("pontos turistico:1\n");

printf("\n");

printf("Quantos pontos turisticos tem em Cavalcante?\n");
scanf("%d",&Pontos_turisticos);
printf("\n");
...
printf("estado:Goiás\n");
printf("carta:G03\n");
printf("cidade:Caldas Novas\n");
printf("população:104.788\n");
printf("area km²:1.608,523\n");
printf("PIB:31.527,54\n");
printf("pontos turistico:1\n");

printf("\n");

printf("Qual a Area Km² de Caldas novas?\n");
scanf("%d",&Area);
printf("\n");
